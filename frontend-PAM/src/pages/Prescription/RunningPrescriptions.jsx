        ...
        <div className="max-h-[550px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 p-2">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {prescriptions.map((prescription) => (
              <div 
                key={prescription.id}
                className="bg-white p-4 rounded-lg border border-[#A9DFBF] transform transition-transform hover:scale-105 hover:shadow-lg hover:border-[#1e7b43]"
              >
                <p className="text-center text-xl font-medium text-[rgb(44,62,80)] mb-2">Patient: {prescription.patientName}</p>
                
                <div className="space-y-2 mb-4">
                <h3 className="text-green-700 underline">
